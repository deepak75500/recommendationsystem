...
model = pickle.load(open('Build-a-Travel-Recommendation-System-with-Flask-Machine-Learning-and-Collaborative-Filtering-main/model.pkl','rb'))
label_encoders = pickle.load(open('Build-a-Travel-Recommendation-System-with-Flask-Machine-Learning-and-Collaborative-Filtering-main/label_encoders.pkl','rb'))

destinations_df = pd.read_csv("Build-a-Travel-Recommendation-System-with-Flask-Machine-Learning-and-Collaborative-Filtering-main/Expanded_Destinations.csv")
userhistory_df = pd.read_csv("Build-a-Travel-Recommendation-System-with-Flask-Machine-Learning-and-Collaborative-Filtering-main/Final_Updated_Expanded_UserHistory.csv")
df = pd.read_csv("Build-a-Travel-Recommendation-System-with-Flask-Machine-Learning-and-Collaborative-Filtering-main/final_df.csv")
